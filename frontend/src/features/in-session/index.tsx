...
export const InSessionFeature: React.FC = () => {
    ...
    return (
      <div className="flex min-h-[100dvh] flex-col items-center justify-center p-6 text-center">
        ...
        <p className="text-xs text-slate-500 mt-1 max-w-xs">
          There is no session in progress. Create a new session to generate the match schedule.
        </p>
        <button
          type="button"
  ...
  return (
    <div className="flex min-h-[100dvh] flex-col bg-slate-50 text-slate-900 antialiased font-sans">
