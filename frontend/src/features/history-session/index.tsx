  ...
  if (!session) {
    return (
      <div className="flex flex-1 flex-col items-center justify-center p-6 text-center">
        ...
        <h2 className="text-lg font-black text-slate-900">Session Not Found</h2>
    ...
    <div className="flex flex-1 flex-col justify-between max-w-md mx-auto w-full px-4 py-6 select-none font-sans">
      <div className="space-y-4">
        ...
        <div className="text-center pt-1">
          <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-court-100 text-2xl shadow-sm mb-2 border border-court-500/20">
            📋
          </div>
          <h1 className="text-2xl font-black tracking-tight text-slate-900">
            {session.title || "Tennis Session"}
          </h1>
          <p className="text-xs text-court-700 font-bold mt-0.5">
        ...
        {/* Notification toast */}
        {notification && (
          <div className="rounded-2xl bg-court-850 text-volt-300 text-xs font-black py-3 px-4 text-center shadow-lg flex items-center justify-center gap-2 border border-court-700/50">
            <span>✓</span>
